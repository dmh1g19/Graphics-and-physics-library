 ...
 * physicsEngine.cpp
 * 
 * This module implements the physics and rendering components of the application.
 * It includes functions for initializing the physics world, stepping the physics
 * simulation, adding shapes and joints to the world, and rendering the shapes.
 *
 * The functionalities provided by this module include:
 * - stepPhysics: Advances the physics simulation and updates positions of edge circles.
 * - initWorld: Initializes the Box2D world with gravity.
 * - addCircle: Adds a circle to the physics world and associates it with a graphical shape.
 * - addDistanceJoint: Creates a distance joint between two bodies.
 * - addEdge: Connects two bodies with a series of circles forming an edge.
 * - addToMap: Associates a graphical shape with a physics body.
 * - renderScene: Renders all the shapes in the scene using OpenGL.
 *
